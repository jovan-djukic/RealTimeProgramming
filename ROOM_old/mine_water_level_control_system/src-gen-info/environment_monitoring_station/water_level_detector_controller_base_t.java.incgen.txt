...
public abstract class water_level_detector_controller_base_t extends environment_station_actor_base_t {
	...
	//--------------------- construction
	public water_level_detector_controller_base_t(IRTObject parent, String name) {
		super(parent, name);
		setClassName("water_level_detector_controller_base_t");
	...
	private int executeTransitionChain(int chain__et, InterfaceItemBase ifitem, Object generic_data__et) {
		switch (chain__et) {
			case water_level_detector_controller_base_t.CHAIN_TRANS_INITIAL_TO__waiting_for_imessage:
			{
				return STATE_waiting_for_imessage;
			}
			case water_level_detector_controller_base_t.CHAIN_TRANS_imessage_received_FROM_waiting_for_imessage_TO_querying_BY_initializeiport:
			{
			...
			case water_level_detector_controller_base_t.CHAIN_TRANS_timeout_received_FROM_querying_TO_querying_BY_timeouttimer_access_point_timeout_received:
			{
				return STATE_querying;
			}
				default:
	...
	public void executeInitTransition() {
		int chain__et = water_level_detector_controller_base_t.CHAIN_TRANS_INITIAL_TO__waiting_for_imessage;
			    ...
			    case STATE_waiting_for_imessage:
			        switch(trigger__et) {
			                case TRIG_iport__initialize:
			                    {
			                        chain__et = water_level_detector_controller_base_t.CHAIN_TRANS_imessage_received_FROM_waiting_for_imessage_TO_querying_BY_initializeiport;
			    ...
			    case STATE_querying:
			        switch(trigger__et) {
			                case TRIG_timer_access_point__timeout:
			                    {
			                        chain__et = water_level_detector_controller_base_t.CHAIN_TRANS_timeout_received_FROM_querying_TO_querying_BY_timeouttimer_access_point_timeout_received;
			                        catching_state__et = STATE_TOP;
			                    }
			                break;
			                default:
