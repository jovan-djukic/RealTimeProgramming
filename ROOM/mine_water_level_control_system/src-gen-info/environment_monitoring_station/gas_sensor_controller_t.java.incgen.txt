...
public class gas_sensor_controller_t extends environment_station_actor_base_t {
	...
	private int executeTransitionChain(int chain__et, InterfaceItemBase ifitem, Object generic_data__et) {
		switch (chain__et) {
			...
			case gas_sensor_controller_t.CHAIN_TRANS_imessage_received_FROM_waiting_for_imessage_TO_querying_BY_initializeiport:
			{
			...
			case gas_sensor_controller_t.CHAIN_TRANS_timeout_received_FROM_querying_TO_querying_BY_timeouttimer_access_point_timeout_received:
			{
				return STATE_querying;
			}
				default:
			    ...
			    case STATE_waiting_for_imessage:
			        switch(trigger__et) {
			                case TRIG_iport__initialize:
			                    {
			                        chain__et = gas_sensor_controller_t.CHAIN_TRANS_imessage_received_FROM_waiting_for_imessage_TO_querying_BY_initializeiport;
			    ...
			    case STATE_querying:
			        switch(trigger__et) {
			                case TRIG_timer_access_point__timeout:
			                    {
			                        chain__et = gas_sensor_controller_t.CHAIN_TRANS_timeout_received_FROM_querying_TO_querying_BY_timeouttimer_access_point_timeout_received;
			                        catching_state__et = STATE_TOP;
			                    }
			                break;
			                default:
