...
public abstract class environment_station_actor_base_t extends ActorClassBase {
	...
	//--------------------- ports
	protected environmonet_statition_actor_base_iprotocol_tPort iport = null;
	...
	//--------------------- construction
	public environment_station_actor_base_t(IRTObject parent, String name) {
		super(parent, name);
		setClassName("environment_station_actor_base_t");

		// initialize attributes
		this.setPeriod(0);

		// own ports
		iport = new environmonet_statition_actor_base_iprotocol_tPort(this, "iport", IFITEM_iport);
	...
	//--------------------- port getters
	public environmonet_statition_actor_base_iprotocol_tPort getIport (){
		return this.iport;
	}
	...
	public static final int TRIG_iport__initialize = IFITEM_iport + EVT_SHIFT*environmonet_statition_actor_base_iprotocol_t.IN_initialize;
	...
	private int executeTransitionChain(int chain__et, InterfaceItemBase ifitem, Object generic_data__et) {
		switch (chain__et) {
			case environment_station_actor_base_t.CHAIN_TRANS_INITIAL_TO__waiting_for_imessage:
			{
				return STATE_waiting_for_imessage;
			}
			case environment_station_actor_base_t.CHAIN_TRANS_imessage_received_FROM_waiting_for_imessage_TO_querying_BY_initializeiport:
			{
			...
			case environment_station_actor_base_t.CHAIN_TRANS_timeout_received_FROM_querying_TO_querying_BY_timeouttimer_access_point_timeout_received:
			{
				return STATE_querying;
			}
				default:
	...
	public void executeInitTransition() {
		int chain__et = environment_station_actor_base_t.CHAIN_TRANS_INITIAL_TO__waiting_for_imessage;
			    ...
			    case STATE_waiting_for_imessage:
			        switch(trigger__et) {
			                case TRIG_iport__initialize:
			                    {
			                        chain__et = environment_station_actor_base_t.CHAIN_TRANS_imessage_received_FROM_waiting_for_imessage_TO_querying_BY_initializeiport;
			    ...
			    case STATE_querying:
			        switch(trigger__et) {
			                case TRIG_timer_access_point__timeout:
			                    {
			                        chain__et = environment_station_actor_base_t.CHAIN_TRANS_timeout_received_FROM_querying_TO_querying_BY_timeouttimer_access_point_timeout_received;
			                        catching_state__et = STATE_TOP;
			                    }
			                break;
			                default:
